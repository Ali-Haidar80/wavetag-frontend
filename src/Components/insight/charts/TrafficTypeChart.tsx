"use client";
import { Trafficoptions } from "@/utils/charts";
  ...
  return (
    <div className="w-[50%] md:w-[30%]">
      <p className="text-secondary-500   mt-6 text-[1.375rem] font-semibold mb-2">
       ...
       <div className="flex items-center justify-center pl-5 md:pl-0 h-[176px] md:h-[235px] bg-light-100 rounded-3xl">
       <p className="flex flex-col gap-3 mx-3">
          <p className="flex items-center gap-2"><div className="w-[25px] h-[25px] bg-info-100 rounded-full" /><span className="text-[12px] font-medium">Direct On</span><span className="text-[12px] font-medium text-secondary-400  ">50%</span></p>
...
export default TrafficTypeChart;
